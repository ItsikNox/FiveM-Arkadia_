...
-- System Infos
PerformHttpRequest(DiscordWebhookStart, function(Error, Content, Head) end, 'POST', json.encode({username = SystemName, content = '**@everyone Le serveur a fini de chargé, vous avez maintenant l\'autorisation de le rejoindre grace à l\'ip suivante : "54.36.218.90:30120"**'}), { ['Content-Type'] = 'application/json' })
