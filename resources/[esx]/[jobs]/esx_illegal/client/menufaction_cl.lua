          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_faction3:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_faction3:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_faction3:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                TriggerServerEvent('esx_faction3:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnableESXIdentity then
    ...
    ESX.TriggerServerCallback('esx_faction3:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_faction3:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_faction3:getVehicleInfos', function(infos)
...
RegisterNetEvent('esx_faction3:handcuff')
AddEventHandler('esx_faction3:handcuff', function()
...
RegisterNetEvent('esx_faction3:drag')
AddEventHandler('esx_faction3:drag', function(cop)
...
RegisterNetEvent('esx_faction3:putInVehicle')
AddEventHandler('esx_faction3:putInVehicle', function()
...
RegisterNetEvent('esx_faction3:OutVehicle')
AddEventHandler('esx_faction3:OutVehicle', function(t)
...
Citizen.CreateThread(function()
    while true do
		...
		if IsControlPressed(0,  Keys['F9']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'illegal' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bandits_actions') and (GetGameTimer() - GUI.Time) > 150 then
		  OpenBanditsMenu()
        end 
    end
end)
