...
local blips = {
  ...
  {title="~c~Mercenaire", colour=39, id=84, x = -1535.97, y = 108.05, z = 56.77}
  }
  Citizen.CreateThread(function()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      if data.current.value == 'item' then
        TriggerServerEvent('esx_mercenaire:buyItem')
      end

      if data.current.value == 'item1' then
        TriggerServerEvent('esx_mercenaire:buyItem1')
      end

      if data.current.value == 'item2' then
        TriggerServerEvent('esx_mercenaire:buyItem2')
      end
      ...
      if data.current.value == 'boss_actions' then
        TriggerEvent('esx_society:openBossMenu', 'mercenaire', function(data, menu)
          menu.close()
        end)
      end
...
function OpenGetStocksBanditsMenu()
  ...
  ESX.TriggerServerCallback('esx_mercenaire:getStockItemsBandits', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_mercenaire:getStockItemsBandits', itemName, count)
            end
...
ESX.TriggerServerCallback('esx_mercenaire:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_mercenaire:putStockItemsBandits', itemName, count)
            end
  ...
  if Config.EnableArmoryManagement then
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_mercenaire:giveWeaponBandits', weapon,  1000)
      end,
      function(data, menu)
...
function OpenGetWeaponBanditsMenu(station)
  ...
  ESX.TriggerServerCallback('esx_mercenaire:getArmoryWeaponsBandits', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_mercenaire:removeArmoryWeaponBandits', function()
...
function OpenPutWeaponBanditsMenu(station)
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_mercenaire:addArmoryWeaponBandits', function()
  ...
  ESX.TriggerServerCallback('esx_mercenaire:getArmoryWeaponsBandits', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_mercenaire:buyBandits', function(hasEnoughMoney)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.value == 'formol' then
          menu.close()
          TriggerServerEvent('esx_mercenaire:startHarvestBandits')
        end
      end,
      function(data, menu)
        menu.close()
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.value == 'puce' then
          menu.close()
          TriggerServerEvent('esx_mercenaire:startHarvest2Bandits')
        end
      end,
      function(data, menu)
        menu.close()
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value == 'spark' then
          menu.close()
          TriggerServerEvent('esx_mercenaire:startHarvest3Bandits')
        end

        if data.current.value == 'tesla' then
          menu.close()
          TriggerServerEvent('esx_mercenaire:startHarvest4Bandits')
        end
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.value == 'sedatif' then
          menu.close()
          TriggerServerEvent('esx_mercenaire:startCraftBandits')
        end

        if data.current.value == 'cryptedphone' then
          menu.close()
          TriggerServerEvent('esx_mercenaire:startCraft2Bandits')
        end

        if data.current.value == 'lightbreak' then
          menu.close()
          TriggerServerEvent('esx_mercenaire:startCraft3Bandits')
        end
...
AddEventHandler('esx_mercenaire:hasEnteredMarkerBandits', function(zone, station, part, partNum)
...
AddEventHandler('esx_mercenaire:hasExitedMarkerBandits', function(zone, station, part, partNum)

  if zone == 'HarvestBandits' then
    TriggerServerEvent('esx_mercenaire:stopHarvestBandits')
  end

  if zone == 'HarvestBandits2' then
    TriggerServerEvent('esx_mercenaire:stopHarvest2Bandits')
  end  

  if zone == 'HarvestBandits3' then
    TriggerServerEvent('esx_mercenaire:stopHarvest3Bandits')
    TriggerServerEvent('esx_mercenaire:stopHarvest4Bandits')
  end
  
  if zone == 'CraftBandits' then
    TriggerServerEvent('esx_mercenaire:stopCraftBandits')
    TriggerServerEvent('esx_mercenaire:stopCraft2Bandits')
    TriggerServerEvent('esx_mercenaire:stopCraft3Bandits')
  end
...
Citizen.CreateThread(function()
  while true do
    ...
    if PlayerData.job2 ~= nil and PlayerData.job2.name == 'mercenaire' then
  ...
  while true do
    ...
    if PlayerData.job2 ~= nil and PlayerData.job2.name == 'mercenaire' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastZone ~= currentZone or LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('esx_mercenaire:hasExitedMarkerBandits', LastZone, LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('esx_mercenaire:hasEnteredMarkerBandits', currentZone, currentStation, currentPart, currentPartNum)
      end
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'mercenaire' and (GetGameTimer() - GUI.Time) > 300 then
...
AddEventHandler('esx_mercenaire:teleportMarkers', function(position)
...
function OpenGetBlackMoney()
  ...
  ESX.TriggerServerCallback('esx_mercenaire:getBlackMoneySociety', function(inventory)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        if data.current.type == 'item_weapon' then
          menu.close()
          TriggerServerEvent('esx_mercenaire:getItem', data.current.type, data.current.value, data.current.ammo)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data2, menu)
              ...
              if quantity == nil then
                ...
                menu.close()
                TriggerServerEvent('esx_mercenaire:getItem', data.current.type, data.current.value, quantity)
                ESX.SetTimeout(300, function()
                  OpenGetBlackMoney()
                end)
              end
...
function OpenPutBlackMoney()
  ...
  ESX.TriggerServerCallback('esx_mercenaire:getPlayerInventory2', function(inventory)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.type == 'item_weapon' then
          ...
          TriggerServerEvent('esx_mercenaire:putItem', data.current.type, data.current.value, data.current.ammo)
          ...
          ESX.UI.Menu.Open(
            ...
            function(data2, menu)
              ...
              TriggerServerEvent('esx_mercenaire:putItem', data.current.type, data.current.value, tonumber(data2.value))
