          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_podolskaia:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_podolskaia:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_podolskaia:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                TriggerServerEvent('esx_podolskaia:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnableESXIdentity then
    ...
    ESX.TriggerServerCallback('esx_podolskaia:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_podolskaia:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_podolskaia:getVehicleInfos', function(infos)
...
RegisterNetEvent('esx_podolskaia:handcuff')
AddEventHandler('esx_podolskaia:handcuff', function()
...
RegisterNetEvent('esx_podolskaia:drag')
AddEventHandler('esx_podolskaia:drag', function(cop)
...
RegisterNetEvent('esx_podolskaia:putInVehicle')
AddEventHandler('esx_podolskaia:putInVehicle', function()
...
RegisterNetEvent('esx_podolskaia:OutVehicle')
AddEventHandler('esx_podolskaia:OutVehicle', function(t)
...
Citizen.CreateThread(function()
    while true do
		...
		if IsControlPressed(0,  Keys['F9']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'podolskaia' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bandits_actions') and (GetGameTimer() - GUI.Time) > 150 then
		  OpenBanditsMenu()
        end 
    end
end)
