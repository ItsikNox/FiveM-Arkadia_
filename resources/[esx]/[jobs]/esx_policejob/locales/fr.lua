Locales['fr'] = {
  ...
  -- Stocks
  ['get_radio'] = 'Ajouter 1x Radio Stock police',
  ['remove_object1'] = 'Prendre Stock Police',
  ['deposit_object1'] = 'Déposer Stock Police',
  ['remove_object'] = 'Prendre une saisi',
  ['deposit_object'] = 'Déposer une saisi',
  ['stocks'] = 'Saisi de Police',
  ['open_stocks'] = 'Appuyez sur ~INPUT_CONTEXT~ pour accéder au Saisi de Police',
  -- Vehicles
  ...
  ['phone_police'] = 'police',
  ['Used_ppa'] = 'Vous avez reçu le Permis de Port d\'Armes',
}
