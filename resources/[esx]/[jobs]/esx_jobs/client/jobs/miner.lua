Config.Jobs.miner = {
	...
	Zones = {
		...
		Mine = {
			Pos = {x = 882.71, y = -2183.85, z = 29.53},
		...
		StoneWash = {
			Pos = {x = 876.93, y = -2186.07, z = 29.53},
			Size = {x = 5.0, y = 5.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			Marker = 1,
			Blip = true,
		...
		Foundry = {
			Pos = {x = 870.64, y = -2191.64, z = 29.86},
			Size = {x = 5.0, y = 5.0, z = 1.0},
			Color = {r = 204, g = 204, b = 0},
			Marker = 1,
			Blip = true,
		...
		CopperDelivery = {
			Pos = {x = -863.45, y = -2192.61, z = 29.68},
			Color = {r = 204, g = 204, b = 0},
		...
		IronDelivery = {
			Pos = {x = 856.01, y = -2190.16, z = 29.84},
			Color = {r = 204, g = 204, b = 0},
			Size = {x = 5.0, y = 5.0, z = 3.0},
			Color = {r = 204, g = 204, b = 0},
			Marker = 1,
		...
		DiamondDelivery = {
			Pos = {x = 844.49, y = -2184.79, z = 29.41},
			Color = {r = 204, g = 204, b = 0},
			Size = {x = 5.0, y = 5.0, z = 3.0},
			Color = {r = 204, g = 204, b = 0},
			Marker = 1,
