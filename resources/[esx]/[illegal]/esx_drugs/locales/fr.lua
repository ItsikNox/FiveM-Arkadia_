Locales['fr'] = {
	...
	['press_collect_opium'] = "appuyez sur ~INPUT_CONTEXT~ pour récolter de l'ecstasy",
	['press_process_opium'] = "appuyez sur ~INPUT_CONTEXT~ pour traiter l'ecstasy",
	['press_sell_opium'] = "appuyez sur ~INPUT_CONTEXT~ pour vendre l'ecstasy",
	...
	['not_enough_opium'] = 'vous n\'avez pas assez d\'ecstasy à ~r~conditionner~s~',
	['sold_one_opium'] = 'vous avez vendu ~g~x1 Pochon de d\'ecstasy~s~',
	['used_one_opium'] = 'Vous avez utilisé 1 Pochon de d\'~b~ecstasy',
	...
	['opium_field'] = 'ecstasy Field',
	['opium_processing'] = 'ecstasy Processing',
	['opium_dealer'] = 'ecstasy Dealer',
}